...
--- Refresh the classic tracker display with current group data.
function ns.refreshClassicDisplay()
    if not trackerFrame then createTrackerFrame() end
...
--- Toggle the classic tracker frame visibility.
function ns.toggleClassicDisplay()
...
--- Show the classic tracker frame.
function ns.showClassicDisplay()
    if not trackerFrame then
        createTrackerFrame()
    end
    restoreFramePosition()
...
--- Hide the classic tracker frame.
function ns.hideClassicDisplay()
